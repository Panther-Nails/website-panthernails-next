...
import Header, { NavLinks, NavLink } from "components/headers/light.js";
...
export default ({
  products = [
    {
      imageSrc:
        "https://images.unsplash.com/photo-1625795782700-8acde893181c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8bWlzc2lvbnxlbnwwfDF8MHx8fDA%3D&auto=format&fit=crop&w=400&q=60",
      title: "Mission",
    ...
    {
      imageSrc:
        "https://images.unsplash.com/photo-1600880292089-90a7e086ee0c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=687&q=80",
      title: "Values",
      description:
  ...
  return (
    <AnimationRevealPage>
      ...
      <Card
        ...
        heading={
          <>
            What We <HighlightedText>Believe</HighlightedText>
          </>
        }
        description=""
        cards={[
          {
            title: "TRUSTWORTHY",
            description:
              "Armed with domain expertise and meticulous forecasts we allow  your business to escalate.",
          },
          {
            title: "INNOVATION",
            description:
              "Futuristic approach while introducing new products to achieve our vision and mission thereby delivering best outputs.",
          },
          {
            title: "RESPONSIBILITY",
            description:
              "We believe in taking responsibility for what we offer and desire to offer best at reasonable rates along with being responsive for after sales support. ",
          },
          {
            title: "INTEGRITY",
            description:
              "When we face a difficult situation we never compromise our values and principles. We do what is right and not what is easiest. ",
          },
          {
            title: "EXCELLENCE",
            description:
              "We truly believe in our caliber for thoroughly delivering outstanding product and maintain the culture of excellence every single day.",
          },
          {
            title: "RELIABLE",
            description:
              "While considering our clients as assets we pursue relationships with our clients based on transparency, persistence, mutual trust and integrity.",
          },
        ]}
      />
