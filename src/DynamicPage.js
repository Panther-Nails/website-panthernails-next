...
import PricingPage from "pages/Products.js";
...
import { Execute, ExecuteQuery } from "services/APIService";
  ...
  try {
    ...
    return (
      <AnimationRevealPage>
        ...
        {data.items.map((component, index) => {
          switch (component.ComponentName) {
            case "Hero":
              return <BackgroundAsImageHero />;
            case "Hero2":
              return <FeaturesAndTestimonialHero />;

            case "About":
              return <SliderCards />;
            case "Features":
              return <TabGridCards data={component} />;
            case "Products":
              return <WithStatsAndImageFeatures />;
            case "CTA":
              return <GetStartedCTA />;
            case "Footer":
              return <FiveColumnDarkFooter />;
          }
        })}
      </AnimationRevealPage>
    );
