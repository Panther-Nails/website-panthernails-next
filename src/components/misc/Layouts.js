...
export const ContentWithPaddingForHomePage= tw.div`max-w-screen-xl mx-auto py-20 lg:py-24 bg-blue-300 rounded-lg bg-purple-500`;
export const Body = tw.div`bg-gray-300 pt-0`;
