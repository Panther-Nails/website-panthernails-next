...
export const Container = styled.div(props => [
    ...
    props.Container === 'ItemscenterCol'? tw` flex-col p-4 bg-transparent` :
    props.Container === 'Itemscenterbgtransparent'? tw` ` :
    props.Container === 'ItemscenterColWidthhalf'? tw` ${a} ` :
    ...
    props.Container === 'StickContainerontop'? tw` md:(h-screen w-1/2 ) z-30 sticky top-0 bg-sitecolor-100 ` :
    tw``,
  ]);

  export const Containerbgcolor = styled.div(props => [
    tw`bg-primary-100 `,
    props.Containerbgcolor === 'sitebgcolor'? tw` bg-sitecolor-100 ` :
    tw``,
  ]);
  ...
  export const SimpleContainer = styled.div(props => [
    ...
    props.SimpleContainer === 'Defultcontainercentercol'? tw`items-center  mt-2  justify-center w-full h-full  flex flex-col ` :
