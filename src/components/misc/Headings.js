...
export const SectionHeading = tw.h2`text-4xl text-sitecolor-300 bg-sitecolor-100 lg:text-5xl text-center tracking-wide px-6 lg:w-full `
...
export const HighlightedText = tw.span`text-sitecolor-900`;
  ...
  export const Heading = styled.h1(props => [
    tw`text-sitecolor-900 bg-sitecolor-100 text-center`,
