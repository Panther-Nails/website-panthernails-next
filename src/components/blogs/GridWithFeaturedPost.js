...
import { NewContainer, ContentWithPaddingXl } from "components/misc/Layouts";
...
const PostTitle = tw.h6`font-bold group-hocus:text-sitecolor-900 transition duration-300 `;
...
export default ({
  ...
  return (
    <NewContainer NCbgcolor={"newcolor"} NCrounded={"4"} NCmargin={"margin4"} NCoverflow={"overflowhide"} >
