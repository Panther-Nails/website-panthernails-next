...
const UpButton = tw.button` w-12 h-12 lg:(w-16 h-16 p-4) duration-200 hocus:scale-x-110 hocus:scale-y-110 bg-[#E5E5E5] p-2 fixed z-50 bottom-0 right-0 mb-20 mr-4 rounded-full `;
