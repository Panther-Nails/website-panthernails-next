...
const Input = tw.input`bg-gray-900 sm:text-white px-6 py-3 rounded text-center sm:rounded-r-none border-2 sm:border-r-0 border-sitecolor-300 hover:border-sitecolor-900 focus:outline-none transition duration-300 w-full`;//chenge bg gary-300 to 900,chenge border color gary-500 to green 14-2-24
...
const SocialLink = styled.a`
  ${tw`cursor-pointer p-2 rounded-full bg-gray-900 text-gray-100 hover:bg-sitecolor-900 transition duration-300 mr-4 last:mr-0`}
  svg {
    ${tw`w-12 h-8`}
  }
`;
