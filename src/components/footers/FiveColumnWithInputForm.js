...
const Input = tw.input`bg-gray-900 px-6 py-3 rounded text-center sm:rounded-r-none border-2 sm:border-r-0 border-sitecolor-300 hover:border-sitecolor-900 focus:outline-none transition duration-300 w-full`;//chenge bg gary-300 to 900,chenge border color gary-500 to green 14-2-24
