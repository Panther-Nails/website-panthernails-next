...
const CardTitle = tw.h3` text-lg font-semibold group-hover:text-primary-500 `;
  ...
  return (
    <Container>
      <ContentWithPaddingXl>
        <HeaderRow>
          <HighlightedHeading textPosition={tw`md:text-left md:w-1/2`}>
            {properties.heading}
          </HighlightedHeading>
              ...
              <CardContainer key={index}>
                ...
                >
                  <CardImageContainer imageSrc={card.imageSrc}>
                    ...
                    >
                      <CardButton>{properties.buttonText}</CardButton>
                    </CardHoverOverlay>
                  </CardImageContainer>
                  <CardText>
