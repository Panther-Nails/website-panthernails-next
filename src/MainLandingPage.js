...
import { LogoLink, NavLink } from "components/headers/light.js";
        ...
        <Content2Xl>
          <NavRow>
            ...
            <div tw="flex flex-wrap justify-center lg:justify-end items-center -mr-12">
              <NavLink
                target="_blank"
                to="https://owaiskhan.me/post/free-tailwindcss-react-ui-kit"
              >
                License & Usage
              </NavLink>
              <NavLink target="_blank" to="https://owaiskhan.me">
                Who Am I ?
              </NavLink>
              <NavLink target="_blank" to="https://twitter.com/owaiswiz">
                Twitter
              </NavLink>
              <NavLink target="_blank" to="mailto:owaiswiz@gmail.com">
                Hire Me!
              </NavLink>
              <div tw="md:hidden flex-100 h-0"></div>
              <PrimaryNavLink target="_blank" to="https://gum.co/QaruQ">
                Download Now
              </PrimaryNavLink>
            </div>
          </NavRow>
          <HeroRow>
            ...
            <TextColumn>
              ...
              <Actions>
                ...
                <SecondaryButton to={secondaryButtonUrl}>
                  {secondaryButtonText}
                </SecondaryButton>
              </Actions>
            </TextColumn>
